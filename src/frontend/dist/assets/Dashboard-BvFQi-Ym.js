import { c as createLucideIcon, j as jsxRuntimeExports, a as cn, u as useRouter, f as useCallerProfile, h as useAvailableOrders, i as useUpdateOrderStatus, r as reactExports, V as Variant_cod_online, O as OrderStatus, g as ue } from "./index-CKfxK87D.js";
import { B as Badge } from "./badge-DE2SuZtv.js";
import { n as Root, C as Content, o as Close, X, T as Title, p as Portal, O as Overlay, M as MessageSquare, m as motion, B as Button, l as FeedbackModal } from "./FeedbackModal-CgQPc10J.js";
import { S as Switch, a as Skeleton } from "./switch-w5AmPakq.js";
...
import { P as Package } from "./package-DZSwDEvy.js";
import { B as Banknote, C as CreditCard } from "./credit-card-DgZ7GTX9.js";
import { C as Clock } from "./clock-DmNl8CBF.js";
import { C as ChevronRight } from "./chevron-right-CaQhUWVo.js";
import "./index-DQuBIG24.js";
/**
...
function Dashboard() {
  ...
  const [showReturnOrder, setShowReturnOrder] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-dvh bg-background pb-36", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 mb-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-medium flex-shrink-0", children: "Delivery radius:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-primary font-bold", children: "KM" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1", children: [1, 3, 5, 10].map((km) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            "data-ocid": "dashboard.toggle",
            onClick: () => setRadiusKm(km),
            className: `text-xs font-bold px-2 py-0.5 rounded-full border transition-colors ${radiusKm === km ? "bg-primary text-primary-foreground border-primary" : "bg-muted/60 text-muted-foreground border-border hover:border-primary/50"}`,
            children: km
          },
          km
        )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-4 mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 bg-amber-500/10 rounded-xl flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCcw, { size: 16, className: "text-amber-400" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: "Return Order" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Mark a delivery as returned" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              ChevronRight,
      ...
      showReturnOrder && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Select the order to return:" }),
            MOCK_ORDERS.slice(0, 2).map((o) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "flex items-center justify-between bg-muted rounded-xl p-3",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: o.id.toUpperCase() }),
