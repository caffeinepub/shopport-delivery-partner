import { c as createLucideIcon, j as jsxRuntimeExports, a as cn, u as useRouter, g as useCallerProfile, h as useAvailableOrders, i as useUpdateOrderStatus, r as reactExports, V as Variant_cod_online, O as OrderStatus, f as ue } from "./index-BfFIGM8q.js";
import { B as Badge } from "./badge-MmEq86QJ.js";
import { B as Button } from "./button-DO-wLprV.js";
import { R as Root, C as Content, a as Close, X, T as Title, P as Portal, O as Overlay } from "./index-9fqKQqlp.js";
import { S as Switch, a as Skeleton } from "./switch-DtvgRysT.js";
import { M as MapPin, L as LiveMap } from "./LiveMap-D-cMg9ka.js";
import { m as motion } from "./proxy-Cw8eKml-.js";
import { S as Star } from "./star-C6_RAerM.js";
import { P as Package } from "./package-BpJKDUqV.js";
import { B as Banknote, C as CreditCard } from "./credit-card-CGzg_3I-.js";
import { C as Clock } from "./clock-CjsmjpBd.js";
import { C as ChevronRight } from "./chevron-right-DAgDSjZ9.js";
import { M as MessageSquare } from "./message-square-CnrJ0oHT.js";
import "./index-DhLe7w7i.js";
import "./index-BKkx8QkT.js";
import "./index-Fw19xUpH.js";
import "./index-rrYdmmmd.js";
/**
...
function Dashboard() {
  ...
  const [locationDenied, setLocationDenied] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-dvh bg-background pb-36", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "px-4 pt-12 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 mb-2", children: [
      ...
      locationDenied && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-amber-300 leading-relaxed", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Location Access Required" }),
              " — Tap ‘Allow Location Access’ on the map below to enable live tracking"
            ] })
          ]
        }
      ),
      ...
      !locationDenied && /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          initial: { opacity: 0, y: 6 },
          animate: { opacity: 1, y: 0 },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-20 left-0 right-0 z-40 px-4 pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-auto", children: activeBreak ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 10 },
        animate: { opacity: 1, y: 0 },
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 bg-white/20 rounded-xl flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Coffee, { size: 16, className: "text-white" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white text-xs font-bold", children: activeBreak.label }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-white/80 text-[11px]", children: [
                "Resumes in ",
                formatBreakTime(breakRemaining)
              ] })
            ] })
      ...
      motion.button,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Coffee, { size: 16 }),
          "☕ Take a Break"
        ]
      }
    ) }) }),
