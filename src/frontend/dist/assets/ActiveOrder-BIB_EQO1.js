import { c as createLucideIcon, u as useRouter, k as useParams, f as useCallerProfile, i as useUpdateOrderStatus, l as useAddCancellation, r as reactExports, O as OrderStatus, V as Variant_cod_online, j as jsxRuntimeExports, a as cn, g as ue } from "./index-CwnI3Qka.js";
import { B as Badge } from "./badge-Bcq3t94K.js";
import { B as Button, m as motion, C as CircleCheck, M as MessageSquare, r as Dialog, s as DialogContent, t as DialogHeader, v as DialogTitle, w as DialogFooter, l as FeedbackModal } from "./FeedbackModal-B7BHAAbR.js";
import { M as MapPin, L as LiveMap, N as Navigation } from "./LiveMap-DgumFYHG.js";
...
import { P as Phone } from "./phone-CeoBQb0_.js";
import { C as ChevronRight } from "./chevron-right-CTdaWqm6.js";
import { A as AnimatePresence } from "./index-D84NyQSG.js";
/**
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-dvh bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-4 mb-5 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 bg-green-500/10 rounded-lg flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, { size: 14, className: "text-green-400" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 bg-primary/10 rounded-lg flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 14, className: "text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
