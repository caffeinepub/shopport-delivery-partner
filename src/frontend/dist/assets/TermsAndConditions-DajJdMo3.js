import { c as createLucideIcon, r as reactExports, u as useRouter, j as jsxRuntimeExports } from "./index-CwnI3Qka.js";
import { B as Button, m as motion, M as MessageSquare, l as FeedbackModal } from "./FeedbackModal-B7BHAAbR.js";
import { S as Separator } from "./separator-yRicY1-P.js";
import { A as ArrowLeft } from "./arrow-left-CvilOwbf.js";
import { F as FileText } from "./file-text-BjJE1VaS.js";
/**
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-dvh bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        className: "mx-4 mb-5",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gradient-to-br from-orange-500/10 to-amber-500/10 border border-orange-500/20 rounded-2xl p-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-orange-500/20 rounded-2xl flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { size: 22, className: "text-orange-400" }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "terms.panel", className: "px-4 pb-8 space-y-4", children: [
      TERMS_SECTIONS.map((section, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 bg-orange-500/10 rounded-xl flex items-center justify-center flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-display font-bold text-orange-400", children: section.number }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          type: "button",
