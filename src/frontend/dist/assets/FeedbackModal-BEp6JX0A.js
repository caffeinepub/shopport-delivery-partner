import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, p as clsx, a as cn, s as React, b as reactDomExports, t as ReactDOM } from "./index-B3_d8K7p.js";
/**
...
async function sendToAdmin(screenName, message) {
...
function FeedbackModal({
  ...
  const [messages, setMessages] = reactExports.useState(getMessages);
  ...
  reactExports.useEffect(() => {
    ...
    if (adminReplies.length > 0) {
      setMessages((prev) => {
        ...
        const newAdminMsgs = adminReplies.filter((r) => !existingIds.has(`admin_${r.id ?? r.date}`)).map((r) => ({
    ...
    Dialog,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        DialogContent,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-primary/10 border-b border-border px-4 pt-4 pb-3 flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-xl bg-primary/20 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { size: 16, className: "text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-sm font-display font-bold leading-tight", children: "Support Chat" }),
                  screenName && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: screenName })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  messages.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-full py-8 text-center", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MessageSquare, { size: 20, className: "text-primary" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground", children: "Send us a message" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "We usually reply within 24 hours" })
                  ] }),
                  messages.map((msg) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      "data-ocid": msg.sender === "user" ? "feedback.success_state" : "feedback.panel",
                      className: `flex ${msg.sender === "user" ? "justify-end" : "justify-start"}`,
                      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "div",
                        {
                          className: `max-w-[80%] px-3 py-2 rounded-2xl ${msg.sender === "user" ? "bg-primary text-primary-foreground rounded-br-sm" : "bg-primary/15 text-foreground border border-primary/20 rounded-bl-sm"}`,
                          children: [
                            msg.sender === "admin" && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-bold text-primary mb-1", children: "Shopport Team" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border px-3 py-3 flex-shrink-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    ...
                    children: sending ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-4 h-4 border-2 border-primary-foreground border-t-transparent rounded-full animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Send, { size: 15 })
                  }
                )
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground mt-1.5 text-center", children: "Message sent to support team" })
            ] })
          ]
        }
      )
