import { c as createLucideIcon, p as commonjsGlobal, q as getDefaultExportFromCjs, r as reactExports, s as clsx, n as React, t as invariant, j as jsxRuntimeExports } from "./index-BfFIGM8q.js";
import { B as Badge } from "./badge-MmEq86QJ.js";
import { P as Package } from "./package-BpJKDUqV.js";
import { C as CircleCheckBig } from "./circle-check-big-Bf8VcDUl.js";
import { S as Star } from "./star-C6_RAerM.js";
import { T as TrendingUp } from "./trending-up-BxCZC3n8.js";
...
function Analytics() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-dvh bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "px-4 pt-12 pb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-display font-bold", children: "Analytics" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Your performance overview" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 space-y-5 pb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: stats.map((stat, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(stat.icon, { size: 20, className: `${stat.color} mb-2` }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `text-2xl font-display font-bold ${stat.color}`, children: stat.value }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          className: "bg-card border border-border rounded-2xl p-4",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold font-display mb-4", children: "Weekly Deliveries" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          className: "bg-card border border-border rounded-2xl p-4",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold font-display mb-4", children: "Weekly Earnings (₹)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 160, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              BarChart,
              {
                data: weeklyData,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold font-display mb-3", children: "Performance Badges" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: badges.map((badge, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(badge.icon, { size: 20, className: badge.color }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: badge.label }),
